...
data:"source_branch=${sourceBranch}&target_branch=$targetBranch&assignee_id=58&title=$title&description=$desc&labels=$labels"

curl --header "PRIVATE-TOKEN: ×××××××××××××" --data ${data} "http://gitlab.qtang.net/api/v3//projects/$project/merge_requests" 