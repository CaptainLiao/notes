...
gulp.task('watch', function () {
    gulp.watch(['./src/less/**/*','./src/js/**/*.js', './src/lib/*.*', './src/*.html'], ['injectFile']);
    //gulp.watch(['./dist/css/**/*','./dist/js/**/*.js'], ['del-maps'])
});
...
gulp.task('product', sequence('clean','copy','injectFile', 'del-maps'));